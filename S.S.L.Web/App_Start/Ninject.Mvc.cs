...
namespace Ninject.Mvc
{
	...
	public class NinjectResolver : IDependencyResolver
	{
		...
		/// <summary>
		/// Creates a new Instance of th Ninject <see cref="Resolver"/> with the modules Supplied
		/// </summary>
		/// <param name="modules">Modules to Load</param>
		public NinjectResolver(params NinjectModule[] modules) => Kernel = new StandardKernel(modules);
